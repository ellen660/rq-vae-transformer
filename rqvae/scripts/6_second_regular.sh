...
#           hyperparameters[".arch.embed_dim"]=$embed
#           hyperparameters[".arch.input_embed_dim"]=$embed
#           hyperparameters[".arch.body.block.embed_dim"]=$embed
#           hyperparameters[".arch.head.block.embed_dim"]=$embed
